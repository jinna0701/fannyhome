...
export default function Program() {
    return (
        <div style={{ backgroundColor: '#FFF8F2', color: 'black' }} className="pl-20 p-10 bg-#FFF8F2">
            <h1 style={{ color: 'black' }} className="text-4xl font-bold mb-8 text-center">What we believe</h1>
            <div className="flex items-center mb-10">
                <div className="flex-1 text-center">
                    <h2 style={{ color: 'black' }} className="text-3xl font-semibold mb-4">We value their smiles</h2>
                    <p style={{ color: 'black' }} className="text-lg">
            ...
            <div className="flex items-center mb-10">
                <div className="flex-1 text-center">
                    <h2 style={{ color: 'black' }} className="text-3xl font-semibold mb-4">Playing is FUN!</h2>
                    <p style={{ color: 'black' }} className="text-lg">
            ...
            <h1 style={{ color: 'black' }} className="text-4xl font-bold mb-8 text-center">Ages</h1>
            <div className="flex items-center mb-10">
                <div className="flex-1 text-center">
                    <h2 style={{ color: 'black' }} className="text-3xl font-semibold mb-4">Infants schedule with development</h2>
                    <p style={{ color: 'black' }} className="text-lg">
            ...
            <div className="flex items-center mb-10">
                <div className="flex-1 text-center">
                    <h2 style={{ color: 'black' }} className="text-3xl font-semibold mb-4">2-3 years schedule with development</h2>
                    <p style={{ color: 'black' }} className="text-lg">
            ...
            <div className="flex items-center mb-10">
                <div className="flex-1 text-center">
                    <h2 style={{ color: 'black' }} className="text-3xl font-semibold mb-4">Pre-school kids schedule with development</h2>
                    <p style={{ color: 'black' }} className="text-lg">
