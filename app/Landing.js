        ...
        <main className="container mx-auto px-4 py-16">
          <div className="flex items-center">
            <div className="w-1/2">
              ...
              <p className="text-black mb-4">An enim nullam tempor sapien gravida donec enim ipsum porta justo congue magna at pretium purus pretium ligula</p>
              <div className="flex space-x-4">
            ...
            <div className="w-1/2">
              <img src="./public/Landing.jpg" alt="Children playing" className="rounded shadow-md"/>
            </div>
          </div>
        </main>
      </div>
